...
module.exports = {
    ...
    /**
     * @param {string} clientSecret provided key to be compared against hash
     * @returns {boolean} true / false depending on token validity
     */
    async isValidMerchantSecret(merchantId) {
        return bcrypt.compare(merchantId, this.merchantSecret);
    },
